...
(function() {
  ...
  Resizer.prototype = {
    ...
    redraw: function() {
      ...
      this._ctx.lineTo(((-this._resizeConstraint.side / 2) - this._ctx.lineWidth / 2) + this._resizeConstraint.side, (-this._resizeConstraint.side / 2) - this._ctx.lineWidth);
      this._ctx.lineTo(((-this._resizeConstraint.side / 2) - this._ctx.lineWidth / 2) + this._resizeConstraint.side, ((-this._resizeConstraint.side / 2) - this._ctx.lineWidth / 2) + this._resizeConstraint.side);
      this._ctx.lineTo((-this._resizeConstraint.side / 2) - this._ctx.lineWidth,
      ((-this._resizeConstraint.side / 2) - this._ctx.lineWidth / 2) + this._resizeConstraint.side);
      this._ctx.lineTo((-this._resizeConstraint.side / 2) - this._ctx.lineWidth,
      (-this._resizeConstraint.side / 2) - this._ctx.lineWidth / 2);
